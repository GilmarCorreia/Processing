...
public class Screen{
  ...
  public void update(){
      ...
      if(esp32.digitalRead(esp32.buttonScale) == 1 && buttonControlScale == false){
      ...
      if(esp32.digitalRead(esp32.buttonScale) == 0 && buttonControlScale == true)
          buttonControlScale = false;
          
      if(esp32.digitalRead(esp32.buttonCursor) == 1 && buttonControlCursor == false){
      ...
      if(esp32.digitalRead(esp32.buttonCursor) ==0 && buttonControlCursor == true)
          buttonControlCursor = false;
      
      if(esp32.digitalRead(esp32.buttonSave) == 1 && buttonControlSave == false){
      ...
      if(esp32.digitalRead(esp32.buttonSave) == 0 && buttonControlSave == true)
          buttonControlSave = false;
          
      if(esp32.digitalRead(esp32.buttonOffset) == 1 && buttonControlOffset == false){
      ...
      if(esp32.digitalRead(esp32.buttonOffset) == 0 && buttonControlOffset == true)
      ...
      if((controlScale%8)==0){
          cursorControl = false;
          scaleXnew = mapX(esp32.analogRead(esp32.potenciometer));
      }
      else if((controlScale%8)==1)
          scaleYnew = mapY(esp32.analogRead(esp32.potenciometer));
      else if((controlScale%8)==2){
          if(!cursorControl)
              save("background.png");
          cursorControl = true;
          cursorX1new = mapCursorX(esp32.analogRead(esp32.potenciometer));
      }
      else if((controlScale%8)==3)
          cursorX2new = mapCursorX(esp32.analogRead(esp32.potenciometer));
      else if((controlScale%8)==4)
          cursorY1new = mapCursorY(esp32.analogRead(esp32.potenciometer));
      else if((controlScale%8)==5)
          cursorY2new = mapCursorY(esp32.analogRead(esp32.potenciometer)); 
      else if((controlScale%8)==6)
          offsetY_new = mapOffsetY(esp32.analogRead(esp32.potenciometer));
      else if((controlScale%8)==7)
          offsetX_new = mapOffsetX(esp32.analogRead(esp32.potenciometer));
  ...
  public float mapOffsetY(float pot){
      return (float)round(map(pot,0,1023,-esp32.espVoltage,esp32.espVoltage),1);
  }
