      ...
      if (executeMultiByteCommand != 0 && waitForData == 0) {
        ...
        switch(executeMultiByteCommand) {
          case DIGITAL_MESSAGE:
            setDigitalInputs(multiByteChannel, (storedInputData[2] << 7) + storedInputData[3]);
            break;
          case ANALOG_MESSAGE:
            setAnalogInput(multiByteChannel, (storedInputData[0] << 15) + (storedInputData[1]<<14) + (storedInputData[2]<<7) + storedInputData[3]);  
            break;
          case REPORT_VERSION:
